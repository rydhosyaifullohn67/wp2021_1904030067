...
<html lang="en">
    ...
    <body id="page-top">
      ...
      <!-- konten -->
      <h3><i class="fas fa-users"></i> Detail Anggota</h3>
      <hr>
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><img src="Image/<?= $camaba['foto']; ?> "width="120px"></li>
          <a href="editanggota.php?idAnggota=<?= $camaba['idAnggota']; ?>" class="btn btn-warning" role="button">Edit</a> |
          <a href="hapus.php?idAnggota=<?= $camaba['idAnggota']; ?>" onclick="return confirm" class="btn btn-danger" role="button">Hapus</a> |
